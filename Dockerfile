...
RUN cd /var/www/html \
 ...
 && git clone --depth 1 https://github.com/edwardspec/mediawiki-moderation.git Moderation \
...
RUN cd /var/www/html/extensions/GbSessionProvider && composer install --no-dev
