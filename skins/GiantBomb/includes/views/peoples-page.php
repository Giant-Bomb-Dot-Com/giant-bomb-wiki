...
/**
 * People page View
 * Displays a list of all people with filtering and pagination
 */
...
static $peopleMetaApplied = false;
if ( !$peopleMetaApplied ) {
	$peopleMetaApplied = true;
	$out = null;
	...
	$out->setHTMLTitle( $GLOBALS['wgSitename'] . ': People' );
}
...
// Query people using helper function
...
$data = [
	...
	'addPersonUrl' => htmlspecialchars('/wiki/Form:Person', ENT_QUOTES, 'UTF-8'),
	'vue' => [
		'peopleJson' => htmlspecialchars(json_encode($result['people']), ENT_QUOTES, 'UTF-8'),
	],
];
...
echo $templateParser->processTemplate('peoples-page', $data);
