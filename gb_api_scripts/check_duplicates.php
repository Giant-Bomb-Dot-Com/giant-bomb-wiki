...
class CheckDuplicates extends Maintenance
{
    ...
    public function __construct() 
    {
        ...
        $this->addOption('ids', 'Entity id. When visiting the GB Wiki, the url has a guid at the end. The id is the number after the dash.', false, true, 'i');
    ...
    {
        $resources = ['accessory','character','company','concept','franchise','game','location','person','platform','thing'];
