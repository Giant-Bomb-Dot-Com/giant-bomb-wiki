...
UPDATE wiki_game_dlc SET mw_page_name = CONCAT('DLCs/', TRIM(mw_page_name));
...
UPDATE wiki_franchise SET mw_page_name = CONCAT('Franchises/', TRIM(mw_page_name));
...
UPDATE wiki_game_theme SET mw_page_name = CONCAT('Themes/', TRIM(mw_page_name));
...
UPDATE wiki_accessory SET mw_page_name = CONCAT('Accessories/', TRIM(mw_page_name));
...
UPDATE wiki_platform SET mw_page_name = CONCAT('Platforms/', TRIM(mw_page_name));
...
UPDATE wiki_location SET mw_page_name = CONCAT('Locations/', TRIM(mw_page_name));
...
UPDATE wiki_character SET mw_page_name = CONCAT('Characters/', TRIM(mw_page_name));
...
UPDATE wiki_thing SET mw_page_name = CONCAT('Objects/', TRIM(mw_page_name));
...
UPDATE wiki_game SET mw_page_name = CONCAT('Games/', TRIM(mw_page_name));
...
UPDATE wiki_game_genre SET mw_page_name = CONCAT('Genres/', TRIM(mw_page_name));
...
UPDATE wiki_person SET mw_page_name = CONCAT('People/', TRIM(mw_page_name));
...
UPDATE wiki_company SET mw_page_name = CONCAT('Companies/', TRIM(mw_page_name));
...
UPDATE wiki_concept SET mw_page_name = CONCAT('Concepts/', TRIM(mw_page_name));